...
const adminApiClient = createAdminApiClient(createApiClient({ baseURL: config.api.adminEndpoint }))
const habitApiClient = createHabitApiClient(createApiClient({ baseURL: config.api.habitEndpoint }))
const authApiClient = createAuthApiClient(createApiClient({ baseURL: config.api.authEndpoint }))
